...
/**
 * <p>Contains loyalty information such as name
 *                 and number.</p>
 *             
 * 
...
@XmlType(name = "LoyaltyData", propOrder = {
    ...
    "pointsToDate",
    "yearToDateRentalCounts",
    "lifetimeToDateRentalCounts",
    "priorYearRentalCounts",
    "loyaltyTier",
    "levelOfServicesCodelists",
    "granted",
    "membershipStartDate",
    "membershipEndDate",
    "redemptionCouponData",
    "creditsNeededForFreeDay",
    "creditsReceived",
    "freeDays",
    "freeDaysOverLifetime",
    "creditsToFreeDayForTier",
    "activityToNextTier",
    "brandCode",
    "brandDescription",
    "pointsExpirationDate",
    "pointsBalanceStatusType"
})
