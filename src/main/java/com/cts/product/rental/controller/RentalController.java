...
public class RentalController {
    ...
    public RentalResponse initiateReservation(HttpServletRequest request,
	    @Valid @RequestBody RentalRequest initiateResReq, @PathVariable("brand") String brand,
	    @PathVariable("channel") String channel, @RequestHeader HttpHeaders headers) throws Exception {
